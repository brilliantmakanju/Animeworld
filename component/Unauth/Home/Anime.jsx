...
const Anime = () => {
  ...
  return (
    <div className='grid grid-cols-1   gap-1 w-[80vw] justify-start py-5 pb-1 ' >
      ...
      <div id='animeSlide' className='pr-5 grid grid-cols-10  gap-[150px] md:grid-cols-10 h-[46vh] py-5 md:w-[85vw] w-screen  md:overflow-y-hidden overflow-x-scroll scrollbar-none md:gap-[185px] aspect-square px-2 ' >
        <CAnime />
      </div>
    </div>
